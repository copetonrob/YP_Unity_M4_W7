...
В этом задании мы сделаем простую мини игру в жанре кликер. Мы создадим две сцены. Одна из них - это главное меню. Пока что в ней будет только кнопка "Начать игру". В основной сцене игры мы сделаем надпись с общим балансом очков и кнопку для увеличения этого баланса на 1.
